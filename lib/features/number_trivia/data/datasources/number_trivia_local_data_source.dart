...
abstract class NumberTriviaLocalDataSource {
  ...
  // Get the cached [NumberTriviaModel] which was gotten the last time the user had an internet connection
  // Throw [NoLocalDataException] if not cached data is present
